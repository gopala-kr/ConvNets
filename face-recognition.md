...
- [SFA: Small Faces Attention Face Detector](https://arxiv.org/abs/1812.08402v1)
- [Face Recognition from Sequential Sparse 3D Data via Deep Registration](https://arxiv.org/abs/1810.09658v2)
- [FML: Face Model Learning from Videos](https://arxiv.org/abs/1812.07603v1)
- [Improving Face Detection Performance with 3D-Rendered Synthetic Data](https://arxiv.org/abs/1812.07363v1)
- [Deep Face Image Retrieval: a Comparative Study with Dictionary Learning](https://arxiv.org/abs/1812.05490v1)
- [FaceFeat-GAN: a Two-Stage Approach for Identity-Preserving Face Synthesis](https://arxiv.org/abs/1812.01288v1)
- [Face Detection in the Operating Room: Comparison of State-of-the-art Methods and a Self-supervised Approach](https://arxiv.org/abs/1811.12296v2)
- [Attacks on State-of-the-Art Face Recognition using Attentional Adversarial Attack Generative Network](https://arxiv.org/abs/1811.12026v2)
- [Automatic Face Aging in Videos via Deep Reinforcement Learning](https://arxiv.org/abs/1811.11082v1)
- [MobiFace: A Lightweight Deep Learning Face Recognition on Mobile Devices](https://arxiv.org/abs/1811.11080v1)
- [LGLG-WPCA: An Effective Texture-based Method for Face Recognition](https://arxiv.org/abs/1811.08345v1)
- [Face Recognition: From Traditional to Deep Learning Methods](https://arxiv.org/abs/1811.00116v1)
